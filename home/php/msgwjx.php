<?php
    ...
    $total = $sql -> count("msg"," where islock = 1 and idnum = ".$idnum,"");
    ...
    $stmt = $sql -> select1("id,name,title,email,content,islock,addtime","msg"," where islock = 1 and idnum = ".$idnum." and addtime > ". strtotime("-10 day")," order by id desc limit {$start},{$num} ");
